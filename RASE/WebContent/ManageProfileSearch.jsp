...
<c:set var="message" value="${requestScope.DataError }" />
...
<form class="example" action="studentSearchServlet" method="post">
  <input type="text" placeholder="Enter Email Id of Student" name="email" required>
